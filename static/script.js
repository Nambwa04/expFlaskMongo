...
function searchContact() {
    ...
    let regNo = regNoInput.value.trim(); // Trim any leading or trailing whitespace
    let user = users.find(user => user.regNo === regNo); // Search for a user with the entered registration number
